...
def initialize_model(gene_vocab_size, smiles_vocab_size, vocab_embedding_dim, lstm_hidden_dim, freeze_gene=False, freeze_smiles=False):
    """
    ...
    if torch.cuda.is_available():
        ...
        print(f'Model training on: {device} ({gpu_name})')
    else:
